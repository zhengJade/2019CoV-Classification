...
class Instructor:
    def __init__(self, opt):
        ...
        if opt.dataset in ['twitter', 'restaurant',  'laptop']:
            self.trainset = ABSADataset(opt.dataset_file['train'], tokenizer) #返回 torch 的dataset类
            self.testset = ABSADataset(opt.dataset_file['test'], tokenizer)
        else:
            self.trainset = CovData(opt.dataset_file['train'], tokenizer) #返回 torch 的dataset类
    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            self.model.train() #当使用dropout是需要转化模式
...
def main():
    ...
    parser.add_argument('--dataset', default='laptop', type=str, help='twitter, restaurant, laptop, weibo')
